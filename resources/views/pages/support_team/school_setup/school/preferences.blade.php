...
<div class="space-y-4">
        ...
        <div class="">
            <div class="card-body py-4 ">
                ...
                <div class="switchElement d-flex gap-2 align-items-center justify-content-between mt-1">
                    ...
                    <h2 class=" pl-2 fs-1 {{ $data[0]->maintenance_status==1?'text-green-600':'text-orange-600' }}" >Maintenance is {{ $data[0]->maintenance_status == 1 ?'on':'off' }} </h2>
                    <div class="toggle">
            ...
            <div class="card-body">
                <div class="mt-3 ">
                    <div class="row">
                        <div class="col-md-4">
                            <h4 class="text-blue-600"> Maintenance Message </h4>
        ...
        <div class="">
            <div class="card-body py-3">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="">
                            <h4 class="text-blue-600"> Email Notifications </h4>
    ...
    <div class="card shadow-none" id="">
        <div class="border-b px-3 text-secondary bg-slate-50  header-elements-inline py-3">
        ...
        <div class="">
            <div class="card-body py-3">
                <div class="d-flex flex-column align-items-start justify-content-between">
                    <div class="">
                            <h4 class="text-blue-600"> Set Half Day and Full-Day Minutes </h4>
