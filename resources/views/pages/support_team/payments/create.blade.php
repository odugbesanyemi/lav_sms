                ...
                <div class="col-md-12">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select-search" name="term_id" id="term_id">
                                    <option value="">Choose Term</option>
                                    <option value="">N/A</option>
                                    @foreach($marking_periods as $mp)
                                        <option {{ old('marking_period') == $mp->id ? 'selected' : '' }} value="{{ $mp->id }}">{{ $mp->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
