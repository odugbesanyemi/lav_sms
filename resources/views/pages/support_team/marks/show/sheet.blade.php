...
<div class="overflow-x-auto p-2">
    <table align="center" class="table table-bordered align-middle text-center m-0 table-striped w-full ">
        <thead>
            <tr class="">
                <th colspan="9" class="fs-3 fw-bold p-3 table-light text-orange-500">COGNITIVE DOMAIN</th>
            </tr>
